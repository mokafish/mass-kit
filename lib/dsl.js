...
import * as builtin from './dsl.builtin.js'
...
export class Interpreter {
    ...
    constructor(
        ...
        this.runtime = new Runtime({ ...Interpreter.baseProcessor, ...processor });
        this.context = {};
        this.graph = []
    }
    ...
    load(input, scope = 'main') {
        ...
        if (this.context[scope]) {
            throw new Interpreter.InterpreterError(`scope "${scope}" existed.`);
        }
